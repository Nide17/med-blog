...
const ScoresPagination = ({ pageNo, setPageNo, numberOfPages }) => {
    ...
    if (numberOfPages <= 3) {
        ...
        middlePagination = [...Array(numberOfPages)].map((_, pageIndex) => (
            <Button
                ...
                style={pageNo === pageIndex + 1 ? { backgroundColor: "#0f0", color: "#fff" } : null}
                key={pageIndex + 1}
            ...
            if (numberOfPages - pageNo >= 3) {
                ...
                middlePagination = (
                    <>
                        ...
                        {[...Array(3)].map((_, pageIndex) => (
                            <Button
                                outline color="success"
                                style={pageNo === startValue + pageIndex + 1 ? { backgroundColor: "#0f0", color: "#fff" } : null}
                                key={startValue + pageIndex + 1}
                                disabled={pageNo === startValue + pageIndex + 1}
                                onClick={() => setPageNo(startValue + pageIndex + 1)}>
                                {startValue + pageIndex + 1}
                ...
                middlePagination = (
                    <>
                        ...
                        <Button
                            outline color="success"
                            style={pageNo === startValue ? { backgroundColor: "#0f0", color: "#fff" } : null}
                            onClick={() => setPageNo(startValue)}>
                            {startValue}
                        </Button>
                        ...
                        {[...Array(amountLeft)].map((_, pageIndex) => (
                            <Button
                                ...
                                key={startValue + pageIndex + 1}
                                disabled={pageNo === startValue + pageIndex + 1}
                                style={pageNo === startValue + pageIndex + 1 ? { backgroundColor: "#0f0", color: "#fff" } : numberOfPages < startValue + pageIndex + 1 ? { visibility: "hidden" } : null}
                                onClick={() => setPageNo(startValue + pageIndex + 1)}>
                                {startValue + pageIndex + 1}
                            </Button>
                        ))}
