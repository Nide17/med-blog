    ...
    return (
        <Form className="mt-5 mx-5">
            <FormGroup row>
                ...
                <Col sm={10}>
                    <Input type="text" name="question" id="examplequestion" placeholder="question with a placeholder" />
                </Col>
            </FormGroup>
            ...
            <FormGroup row>
                ...
                <Col sm={10}>
                    <Input type="text" name="answer" id="exampleanswer" placeholder="answer placeholder" />
                </Col>
            </FormGroup>
